...
# Qwen3-32B: 64 layers, FFN 25600, 64 q-heads, 8 kv-heads (GQA 8:1).
CONFIGS = [
    # ---- TP8 PP1: ffn 25600/8=3200, q 64/8=8, kv 8/8=1 per rank
    ("TP8PP1_uniform", 8, 1, [64],
     [3200] * 8, [8] * 8, [1] * 8),
    ("TP8PP1_ffn_bias+25",  8, 1, [64],
     [4000]*4 + [2400]*4, [8] * 8, [1] * 8),   # 16000+9600=25600
    ("TP8PP1_ffn_bias+50",  8, 1, [64],
     [4800]*4 + [1600]*4, [8] * 8, [1] * 8),   # 19200+6400
    ("TP8PP1_ffn_bias+75",  8, 1, [64],
     [5600]*4 +  [800]*4, [8] * 8, [1] * 8),   # 22400+3200

    # ---- TP4 PP2: 64 layers = 32+32 uniform
    ("TP4PP2_layer_uniform_32-32", 4, 2, [32, 32],
     [6400] * 4, [16] * 4, [2] * 4),
    ("TP4PP2_layer_skew+4_36-28", 4, 2, [36, 28],
     [6400] * 4, [16] * 4, [2] * 4),
    ("TP4PP2_layer_skew+8_40-24", 4, 2, [40, 24],
     [6400] * 4, [16] * 4, [2] * 4),
    ("TP4PP2_layer_skew+12_44-20", 4, 2, [44, 20],
     [6400] * 4, [16] * 4, [2] * 4),
    ("TP4PP2_layer_skew+16_48-16", 4, 2, [48, 16],
     [6400] * 4, [16] * 4, [2] * 4),

    # ---- TP2 PP4: 64/4 = 16 per stage uniform
    ("TP2PP4_layer_uniform_16-16-16-16", 2, 4, [16, 16, 16, 16],
     [12800] * 2, [32] * 2, [4] * 2),
    ("TP2PP4_layer_blackbias_18-18-14-14", 2, 4, [18, 18, 14, 14],
     [12800] * 2, [32] * 2, [4] * 2),
    ("TP2PP4_layer_blackbias_20-20-12-12", 2, 4, [20, 20, 12, 12],
     [12800] * 2, [32] * 2, [4] * 2),

    # ---- TP1 PP8: 64/8 = 8 per stage uniform
    ("TP1PP8_layer_uniform_8x8", 1, 8, [8]*8,
     [25600], [64], [8]),
    ("TP1PP8_layer_blackbias_10-10-10-10-6-6-6-6", 1, 8, [10,10,10,10,6,6,6,6],
     [25600], [64], [8]),
    ("TP1PP8_layer_blackbias_12-12-12-12-4-4-4-4", 1, 8, [12,12,12,12,4,4,4,4],
     [25600], [64], [8]),
]
...
def main():
    ...
    out_root = REPO / "results" / f"hetero_4x4_qwen32b_full_{ts}"
