"""Profile opt30b TP8 decode to find the ~44ms the κ=1 model under-predicts
...
def main():
    out = _REPO / "results" / "opt30b_tp8_profile"
    ...
    print(f"=== opt30b TP8PP1 profile  port={port} ===", flush=True)
    fout = open(log, "w")
    ...
    try:
        ...
        try:
            ...
            pass
        time.sleep(10)
    print("[done] analyze: python planner/qwen_pp_profile_analyze.py results/opt30b_tp8_profile", flush=True)
